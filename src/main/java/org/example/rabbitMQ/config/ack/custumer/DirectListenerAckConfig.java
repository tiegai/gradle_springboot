...
import org.example.rabbitMQ.receiver.ack.DirectAckReceiver;
...
@Configuration
public class DirectListenerAckConfig {
    ...
    public SimpleMessageListenerContainer simpleMessageListenerContainer() {
        ...
        //设置一个队列
        container.setQueueNames("TestDirectAckQueue1","TestDirectAckQueue2");
